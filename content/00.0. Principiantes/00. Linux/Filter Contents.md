...
Filter Contents
```shell-session
rafa181@htb[/htb]$ more /etc/passwd
```
...
 Filter Contents:
```shell-session
rafa181@htb[/htb]$ less /etc/passwd
```
...
 Filter Contents:
```shell-session
rafa181@htb[/htb]$ head /etc/passwd
...
Filter Contents:
```shell-session
rafa181@htb[/htb]$ tail /etc/passwd
...
Filter Contents:
```shell-session
rafa181@htb[/htb]$ cat /etc/passwd | sort
...
Filter Contents:
```shell-session
rafa181@htb[/htb]$ cat /etc/passwd | grep "/bin/bash"
...
Filter Contents:
```shell-session
rafa181@htb[/htb]$ cat /etc/passwd | grep -v "false\|nologin"
...
Filter Contents:
```shell-session
rafa181@htb[/htb]$ cat /etc/passwd | grep -v "false\|nologin" | cut -d":" -f1
...
Filter Contents:
```shell-session
rafa181@htb[/htb]$ cat /etc/passwd | grep -v "false\|nologin" | tr ":" " "
...
```shell-session
rafa181@htb[/htb]$ cat /etc/passwd | grep -v "false\|nologin" | tr ":" " " | column -t
...
```shell-session
rafa181@htb[/htb]$ cat /etc/passwd | grep -v "false\|nologin" | tr ":" " " | awk '{print $1, $NF}'
...
```shell-session
rafa181@htb[/htb]$ cat /etc/passwd | grep -v "false\|nologin" | tr ":" " " | awk '{print $1, $NF}' | sed 's/bin/HTB/g'
...
```shell-session
rafa181@htb[/htb]$ cat /etc/passwd | grep -v "false\|nologin" | tr ":" " " | awk '{print $1, $NF}' | wc -l
